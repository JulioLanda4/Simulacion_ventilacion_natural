...
REAL*4, ALLOCATABLE :: u_obs, v_obs
REAL*4, ALLOCATABLE :: x0_obs1, y0_obs1, xl_obs1, yl_obs1
REAL*4, ALLOCATABLE :: x0_obs2, y0_obs2, xl_obs2, yl_obs2
REAL*4, ALLOCATABLE :: x0_obs3, y0_obs3, xl_obs3, yl_obs3
REAL*4, ALLOCATABLE :: x0_obs4, y0_obs4, xl_obs4, yl_obs4
REAL*4, ALLOCATABLE :: x0_obs5, y0_obs5, xl_obs5, yl_obs5
REAL*4, ALLOCATABLE :: x0_obs6, y0_obs6, xl_obs6, yl_obs6
REAL*4, ALLOCATABLE :: x0_obs7, y0_obs7, xl_obs7, yl_obs7
REAL*4, ALLOCATABLE :: x0_obs8, y0_obs8, xl_obs8, yl_obs8
...
! Definiendo dimensiones del obstaculo 1
x0_obs1=2.5; xl_obs1=2.6; y0_obs1=0.0; yl_obs1=4.0

! Dimensiones del obstaculo 2
x0_obs2=5.0; xl_obs2=5.1; y0_obs2=0.0; yl_obs2=2.0

! Dimensiones del obstaculo 3
x0_obs3=5.0; xl_obs3=5.1; y0_obs3=3.0; yl_obs3=4.1

! Dimensiones del obstaculo 4
x0_obs4=5.0; xl_obs4=13.1; y0_obs4=4.0; yl_obs4=4.1

! Dimensiones del obstaculo 5
x0_obs5=13.0; xl_obs5=13.1; y0_obs5=4.0; yl_obs5=6.0

! Dimensiones del obstaculo 6
x0_obs6=13.0; xl_obs6=15.0; y0_obs6=5.9; yl_obs6=6.0

! Dimensiones del obstaculo 7
x0_obs7=14.9; xl_obs7=15.0; y0_obs7=0.0; yl_obs7=5.0

! Dimensiones del obstaculo 8
x0_obs8=17.0; xl_obs8=17.1; y0_obs8=0.0; yl_obs8=4.0
...
CALL MarcarObstaculo('obs1',nx, ny, xc, yc, x0_obs1, xl_obs1, y0_obs1, yl_obs1, mark_cells, u, v)
CALL MarcarObstaculo('obs2',nx, ny, xc, yc, x0_obs2, xl_obs2, y0_obs2, yl_obs2, mark_cells, u, v)
CALL MarcarObstaculo('obs3',nx, ny, xc, yc, x0_obs3, xl_obs3, y0_obs3, yl_obs3, mark_cells, u, v)
CALL MarcarObstaculo('obs4',nx, ny, xc, yc, x0_obs4, xl_obs4, y0_obs4, yl_obs4, mark_cells, u, v)
CALL MarcarObstaculo('obs5',nx, ny, xc, yc, x0_obs5, xl_obs5, y0_obs5, yl_obs5, mark_cells, u, v)
CALL MarcarObstaculo('obs6',nx, ny, xc, yc, x0_obs6, xl_obs6, y0_obs6, yl_obs6, mark_cells, u, v)
CALL MarcarObstaculo('obs7',nx, ny, xc, yc, x0_obs7, xl_obs7, y0_obs7, yl_obs7, mark_cells, u, v)
CALL MarcarObstaculo('obs8',nx, ny, xc, yc, x0_obs8, xl_obs8, y0_obs8, yl_obs8, mark_cells, u, v)

!::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

!Creacion de arcivho de animacion 
OPEN(2,FILE='anim.gnp',STATUS='REPLACE')
WRITE(2,*)'set xrange[0:20]; set yrange[0:10]; set view map; set size ratio -1'
...
if (mod(it,10) .eq. 0) then
    ...
    write(2,*)"p 'vel"//itchar(1:len_trim(itchar))//".txt' u 1:2:5 w image"
!     write(2,*)"p 'vel"//itchar(1:len_trim(itchar))//".txt' u 1:2:5 w image, 'obs0.txt' w l lc 'white' lw 4, 'obs10.txt' w l lc 'white' lw 4, 'obs20.txt' w l lc 'white' lw 4, 'obs30.txt' w l lc 'white' lw 4, 'obs40.txt' w l lc 'white' lw 4"
    write(2,*)'pause 0.05'
end if
...
subroutine interpolateToNodesUs(uc,us,nx,ny)
    ...
    open(11,file=Filename(1:len_trim(Filename)))
        do i=0,nx+1
        do j=0,ny+1
        write(11,*)xc(i),yc(j),uc(i,j),vc(i,j), sqrt(uc(i,j)*uc(i,j)+vc(i,j)*vc(i,j))
        end do
        write(11,*)''
        end do
    close(11)
    ...
    !:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
! MarcarObstaculo(nx, ny, xc, yc, x0_obs, xl_obs, y0_obs, yl_obs, mark_cells, u, v)

  SUBROUTINE MarcarObstaculo(Name,nx, ny, xc, yc, x0_obs, xl_obs, y0_obs, yl_obs, mark_cells, u, v)

    integer i,j,nx,ny
    real*4 xc(0:nx+1),yc(0:ny+1)
    real*4 x0_obs,xl_obs,y0_obs,yl_obs
    integer mark_cells(0:nx+1,0:ny+1)
    real*4 u(0:nx, 0:ny+1), v(0:nx+1, 0:ny)
    ...
    open(3,file=Filename(1:len_trim(Filename)))
